...
//for resultset
import java.sql.*;
public class BookingForm3 extends JFrame implements ActionListener{
    ...
    BookingForm3(){
        ...
        String course[] = {"306","307","308","309","310"};
        ...
        Icon i3 = new ImageIcon(ClassLoader.getSystemResource("icons/Booking3.png"));
