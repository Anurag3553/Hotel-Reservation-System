...
//for resultset
import java.sql.*;
public class BookingForm6 extends JFrame implements ActionListener{
    ...
    BookingForm6(){
        ...
        String course[] = {"406","407","408","409","410"};
        ...
        Icon i3 = new ImageIcon(ClassLoader.getSystemResource("icons/Booking6.png"));
